...
Therapy" value set using the ([cqf-notDoneValueSet](https://www.hl7.org/fhir/uv/crmi/2023Sep/StructureDefinition-cqf-notDoneValueSet.html)) extension to indicate
